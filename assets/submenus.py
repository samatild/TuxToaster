...
from assets.descriptions import *
...
def cpu_submenu():
    while True:
        ...
        if selected_option == 0:  # Single Core
            run_single_core_stress()  
        elif selected_option == 1:  # All Cores
            run_all_cores_stress()
        elif selected_option == 2:  # Custom Number of Cores
            run_custom_cores_stress()
        elif selected_option == 3:  # Back to Main
            break
...
if __name__ == "__cpu_submenu__":
    cpu_submenu()

if __name__ == "__memory_submenu__":
    memory_submenu()

if __name__ == "__disk_submenu__":
    disk_submenu()

if __name__ == "__network_submenu__":
    network_submenu()