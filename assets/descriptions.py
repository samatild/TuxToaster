...
def preview_networksbumenu(menu_entry):
    descriptions = {
        ...
        "Network OUT (Multiple)": "\033[93mMulti socket packet receiver against Internet Beacon. \n\033[93mUser can define custom socket number.\033[0m",
        "Socket Exaustion": "\033[92mUnder development.\033[0",
...
["Network IN (Single)", "Network OUT (Single)", "Network IN (Multiple)", "Network OUT (Multiple)",
                        "Socket Exaustion",  "Simulate Latencies", "Simulate disconnects", "Simulate packet loss",
                         "Back to Main"]

if __name__ == "__preview_cpusbumenu__":
    preview_cpusbumenu()

if __name__ == "__preview_menu__":
    preview_menu()

if __name__ == "__preview_memsbumenu__":
    preview_memsbumenu()

if __name__ == "__preview_disksbumenu__":
    preview_disksbumenu()

if __name__ == "__preview_networksbumenu__":
