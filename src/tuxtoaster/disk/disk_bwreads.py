...
def io_test(directory, temp_file_path):
    dd_command = f"while true; do dd if={temp_file_path} of=/dev/null bs=4096K iflag=direct status=none; done"
...
def run_bwreads():
    ...
    print(f"{BOLD}{GREEN}Running DISK THROUGHPUT - READS — press ENTER to stop.{RESET}")
