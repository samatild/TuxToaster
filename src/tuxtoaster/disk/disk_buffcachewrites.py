...
def io_test(directory, temp_file_path):
    dd_command = f"while true; do dd if=/dev/zero of={temp_file_path} bs=128K status=none ; done"
...
def run_iobuffwrites():
    ...
    print(f"{BOLD}{GREEN}Running DISK WRITES - Buffer Cache — press ENTER to stop.{RESET}")
