        ...
        if 'children' in device:
            for child in device['children']:
                ...
                if mount_point not in mount_points:
                    ...
                    # Append parent devices if they share the same mount point
                    mount_points[mount_point]['parent_device'] += f", {parent_device_name}"
    return mount_points

if __name__ == "__get_unique_mount_points__":
    get_unique_mount_points()

if __name__ == "__create_dummy_file__":
    create_dummy_file()

if __name__ == "__create_dummy_file_multi__":
    create_dummy_file_multi()